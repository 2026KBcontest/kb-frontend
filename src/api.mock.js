...
export async function mockGetRegionOptions() {
  ...
  return {
    ...
    picks: [
      ...
      {
        /* AI 응답의 altId(2순위). 고른 건 AI 지만 이유 문장은 계산값으로 채운다 —
           AI 가 2순위에 대한 설명까지 써주지는 않아서, 없는 근거를 지어내지 않는다 */
        kind: 'alt',
        label: '그다음으로 볼 만한 곳',
        source: 'ai',
        region: '성북구',
        headline: '성북구도 후보로 남겨둘 만해요',
        reasons: [
          '초기 자금이 21,400,000원 적게 들어요',
          '지금 저축 속도로 228개월이면 돼요',
          'AI 가 두 번째로 꼽은 곳이에요',
        ],
      },
    ],
